 ...
 *  @file
 *  @brief  GsimE14CC00
 *  $Id: GsimE14CC00.cc,v 1.4 2007/02/04 12:56:55 nanjo Exp $ 
 *  $Log: GsimE14CC00.cc,v $
...
GsimE14CC00::GsimE14CC00(std::string name,
  ...
  : GsimDetector(name,motherDetector,transV,rotV,userFlag)
{
  ...
  GsimBoxWithAHole* CC00 = new GsimBoxWithAHole("CC00",this,
						G4ThreeVector(0,0,0),
						G4ThreeVector(0,0,0));
  CC00->setOuterMaterial("G4_Galactic");
  ...
  for ( int i =0; i<11; i++ ) {
    ...
    if(i==0) {
      ...
      boxl->setSensitiveDetector("CC00",1);
  ...
  setThisAndDaughterBriefName("CC00");

}


GsimE14CC00::~GsimE14CC00()
{
  ;
}
...
void GsimE14CC00::setFastSimulationLevel(int level)
{
#ifdef GSIMDEBUG
