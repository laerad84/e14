 ...
 *  @file
 *  @brief  GsimE14FBAR
 *  $Id: GsimE14FBAR.cc,v 1.4 2006/12/06 19:04:45 nanjo Exp $ 
 *  $Log: GsimE14FBAR.cc,v $
...
GsimE14FBAR::GsimE14FBAR(std::string name,
  ...
  : GsimDetector(name,motherDetector,transV,rotV,userFlag)
{
  ...
  for( int i=0;i<16;i++ ){
    ...
    if(i==0) {
      ...
      trapFBA1->setOuterMaterial("G4_Galactic");
  ...
  for( int i=0;i<16;i++ ){
    ...
    if(i==0) {
      ...
      trapFBA2->setOuterMaterial("G4_Galactic");
  ...
  setThisAndDaughterBriefName("FBAR");
}


GsimE14FBAR::~GsimE14FBAR()
{
  ;
}

void GsimE14FBAR::setFastSimulationLevel(int level)
{
#ifdef GSIMDEBUG
