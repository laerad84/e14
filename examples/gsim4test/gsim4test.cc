...
int main(int argc, char** argv)
{
  ...
  new GsimDetectorFactory<GsimE14OEV>(dm,"GsimE14OEV");
  ...
  new GsimDetectorFactory<GsimE14NCC>(dm,"GsimE14NCC");
  ...
  new GsimDetectorFactory<GsimE14LCV>(dm,"GsimE14LCV");
  ...
  new GsimSpectrumFactory<GsimE14SurveySpectrum>("GsimE14SurveySpectrum");
